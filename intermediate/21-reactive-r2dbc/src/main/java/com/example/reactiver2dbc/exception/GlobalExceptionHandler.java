package com.example.reactiver2dbc.exception;
...
/**
 * Global exception handler for the Reactive R2DBC API.
 *
 ...
 * {@code Flux}) to integrate with the non-blocking pipeline. Returning a plain
