...
import com.example.freemarker.service.ProductService;
 ...
 * FreeMarker HTML templates ({@code .ftlh} files).
 *
 * <p>
 ...
 * that the FreeMarker {@code ViewResolver} resolves to a template file
 * under {@code src/main/resources/templates/} with the {@code .ftlh}
 * suffix.</li>
 * </ul>
 * </p>
 *
 ...
 * {@code Map<String, Object>} under the hood) that FreeMarker can access
 * inside templates using expressions like {@code ${products}}. FreeMarker
 * calls this map the <em>data-model</em>.
 * </p>
 */
@Controller
public class ProductController {
     ...
     * @param model    Spring MVC model — attributes added here become FreeMarker
     *                 data-model variables in the template
     * @return the logical view name {@code "index"}, resolved by FreeMarker to
     *         {@code templates/index.ftlh}
     */
    @GetMapping("/")
    public String index(
        ...
        // Populate the model — these keys become FreeMarker data-model variables
        ...
        // Return the logical view name: FreeMarker resolves this to
    ...
    public String productDetail(@PathVariable Long id, Model model) {
        ...
        if (product.isEmpty()) {
            // Resolve to not-found.ftlh and set a helpful message
