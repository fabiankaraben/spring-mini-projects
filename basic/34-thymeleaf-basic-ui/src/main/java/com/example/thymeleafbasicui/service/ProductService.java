package com.example.thymeleafbasicui.service;
 ...
 * Here we use a hard-coded in-memory list so the project stays focused on the
 * Thymeleaf rendering concepts without introducing any persistence complexity.
 * </p>
 *
 * <p>
...
public class ProductService {
     ...
     * The list is immutable (List.of) to make it clear that this layer
     * never mutates data — it only reads and returns it.
     */
