package com.example.mongodbcrudapi.config;
 ...
 * numeric comparison operators like {@code $lte}, {@code $gte}, and {@code $lt}
 * do not work on them — they would apply lexicographic ordering instead.
 *
 ...
 *       {@code Decimal128} type, enabling correct range queries.</li>
...
public class MongoConfig {
     ...
     * suitable for monetary values and enabling correct numeric comparisons.
     */
    @WritingConverter
    static class BigDecimalToDecimal128Converter implements Converter<BigDecimal, Decimal128> {
        @Override
        public Decimal128 convert(BigDecimal source) {
            // Decimal128.parse accepts the string representation of a BigDecimal
            // and creates an exact BSON numeric value from it.
