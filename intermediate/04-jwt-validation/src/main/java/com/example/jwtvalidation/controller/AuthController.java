...
import com.example.jwtvalidation.dto.LoginResponse;
 ...
 * </ol>
 *
 * <p>The validation of that token on subsequent requests is handled by
 * {@code JwtAuthenticationFilter} – <em>that</em> is the focus of this project.</p>
 */
@RestController
...
public class AuthController {
     ...
     * persistence. All new users receive the {@code ROLE_USER} role.</p>
     *
     ...
     * controller only orchestrates the call and converts the result into a JWT.</p>
     *
     * <p><b>Request body example:</b></p>
     * <pre>{@code
     * { "username": "alice", "password": "secret123" }
    ...
    public ResponseEntity<?> login(@Valid @RequestBody LoginRequest request) {
        try {
            ...
            // This is the token the client must store and include in future requests.
